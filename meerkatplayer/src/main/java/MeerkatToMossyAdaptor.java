...
public class MeerkatToMossyAdaptor {
    com.mossy.holdem.Card adaptCard(com.biotools.meerkat.Card meerkatCard) {
    ...
    com.biotools.meerkat.Action adaptAction(com.mossy.holdem.Action mossyAction, com.mossy.holdem.interfaces.state.IFixedLimitState gameState) {
    ...
    com.mossy.holdem.Action adaptAction(com.biotools.meerkat.Action meerkatAction, com.biotools.meerkat.GameInfo gi) {

        switch (meerkatAction.getType()) {
            case com.biotools.meerkat.Action.CHECK:
                return com.mossy.holdem.Action.Factory.checkAction();
            case com.biotools.meerkat.Action.BET:
                return com.mossy.holdem.Action.Factory.betAction(ChipStack.of(meerkatAction.getAmount()));
            case com.biotools.meerkat.Action.RAISE:

                return com.mossy.holdem.Action.Factory.raiseToAction(ChipStack.of(meerkatAction.getToCall() + meerkatAction.getAmount()));

            case com.biotools.meerkat.Action.FOLD:
                return com.mossy.holdem.Action.Factory.foldAction();
            // for now treat muck as fold...
            case com.biotools.meerkat.Action.MUCK:
                return com.mossy.holdem.Action.Factory.foldAction();
            case com.biotools.meerkat.Action.CALL:
                return com.mossy.holdem.Action.Factory.callAction();
            case com.biotools.meerkat.Action.SMALL_BLIND:
                return com.mossy.holdem.Action.Factory.smallBlindAction();
            case com.biotools.meerkat.Action.BIG_BLIND:
                return com.mossy.holdem.Action.Factory.bigBlindAction();
            // TODO fix ante for
            case com.biotools.meerkat.Action.POST_ANTE:
                throw new RuntimeException("Ante not implemented!");
            case com.biotools.meerkat.Action.ALLIN_PASS:
                return com.mossy.holdem.Action.Factory.allInAction();
            case com.biotools.meerkat.Action.SIT_OUT:
                return com.mossy.holdem.Action.Factory.sitOutAction();
            default:
    ...
    com.mossy.holdem.Action adaptStageChangeEvent(int newStage, com.biotools.meerkat.GameInfo gi) {
        ...
        ArrayList<com.mossy.holdem.Card> myBoardCards = new ArrayList<>();

        for(int boardCardIdx = 1; boardCardIdx <= numBoardCards; ++boardCardIdx){
            com.mossy.holdem.Card mossyCard = adaptCard(new Card(boardCards[boardCardIdx]));
        ...
        switch (newStage) {
            case Holdem.FLOP:
                return com.mossy.holdem.Action.Factory.dealFlopAction(myBoardCards.get(0), myBoardCards.get(1), myBoardCards.get(2));
            case Holdem.TURN:
                return com.mossy.holdem.Action.Factory.dealTurnAction(myBoardCards.get(3));
            case Holdem.RIVER:
                return com.mossy.holdem.Action.Factory.dealRiverAction(myBoardCards.get(4));
